/**
 * Geographic proximity linking engine for Rhône (69).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (45.76°N for Lyon)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(45.76°) ≈ 77.5 km
