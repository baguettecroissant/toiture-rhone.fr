---
title: "Toiture plate à Lyon (Confluence, Gerland) : EPDM, PVC-P ou bitume ?"
description: "Quel revêtement choisir pour l'étanchéité d'un toit plat ou toiture terrasse à Lyon ? Avantages, longévité et coûts comparatifs en 2026."
publishDate: "2026-06-22"
image: "/images/guides/toiture-plate-lyon.png"
...
*   **Sécurité du chantier :** Contrairement au bitume, la membrane EPDM is posée à froid, soit par collage complet à la colle contact acrylique, soit fixée mécaniquement ou lestée par du gravier. L'absence totale de flamme élimine le risque d'incendie durant les travaux, un argument décisif pour les [structures à ossature bois](/guides/neige-gel-proteger-toiture-hivers-rhodaniens/).
...
Pour lutter contre le phénomène d'îlots de chaleur urbains très marqué à Lyon en été, le Plan Local d'Urbanisme (PLU) de la Métropole impose ou incite fortement à la végétalisation des toitures plates lors de constructions neuves ou de réfections lourdes en [copropriété](/guides/toiture-copropriete-lyon-syndic-vote-ag-couts/).
